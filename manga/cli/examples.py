...
示例数据集中存放于 ``manga/data/examples.json``，每条为
...
from manga.core.config import COMICINFO_TAGS
from manga.naming.parser import parse_name, emit_parse_debug
from manga.naming.builder import build_new_name
from manga.workflow.metadata import collect_fields, _extract_publisher_name
from base.console import highlight_diff, SEP2, RED, GREEN, emit, print_summary
from manga.presentation.view import print_metadata_diff_table
