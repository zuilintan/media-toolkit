...
# ═══════════════════════════════════════════════════════════════════════════════
# CLI 主入口（pyproject scripts: manga-cli = "manga.cli:main"）
# ═══════════════════════════════════════════════════════════════════════════════

def build_parser() -> argparse.ArgumentParser:
    # 延迟 import 子命令避免循环（manga.cli.name 反向 import 本模块的 validate_root）
    from manga.cli.cover   import cmd_cover,  add_cover_args
    from manga.cli.doctor  import cmd_doctor, add_doctor_args
    from manga.cli.meta    import cmd_meta,   add_meta_args
    from manga.cli.pack    import cmd_pack,   add_pack_args
    from manga.cli.name    import cmd_name,   add_name_args
